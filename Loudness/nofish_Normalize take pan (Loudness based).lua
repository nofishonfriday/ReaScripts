 ...
 *  works via adjusting take pan (stereo takes only), check script's USER CONFIG AREA
--]]

--[[
 * Changelog:
  
 * v0.90 - January 01 2020
...
DIFFERENCE_THRESHOLD = 1.5 -- only normalize pan if Loudness difference between l/r channel >  DIFFERENCE_THRESHOLD
  ...
  for i = 0, selItemsCount-1  do
    ...
    if take ~= nil then
      ...
      if numChan == 2 then
        ...
        Msg("Not a stereo take, skippingg..")
      end
