...
tracksWhoseHWoutsWereSetToMute_Table_pos = 1
function MuteHWOuts()
  ...
  for i = 0, tracksCount-1  do
    ...
    if (HWoutWasSetToMute) then
      tracksWhoseHWoutsWereSetToMute_Table[tracksWhoseHWoutsWereSetToMute_Table_pos] = tr
      tracksWhoseHWoutsWereSetToMute_Table_pos = tracksWhoseHWoutsWereSetToMute_Table_pos + 1 
    end
